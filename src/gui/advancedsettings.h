...
public slots:
    void saveAdvancedSettings()
    {
        ...
        // Auto Ban
        pref->setAutoBan(cb_auto_ban.isChecked());
    }
...
private slots:
    ...
    void loadAdvancedSettings()
    {
        ...
        // Auto Ban
        cb_auto_ban.setChecked(pref->AutoBan());
        setRow(Auto_Ban, tr("Always ban slow uploading peer"), &cb_auto_ban);
    }
};
